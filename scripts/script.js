...
window.onload = function () {
  ...
  function init() {
    ...
    $.getJSON("data/world.json", function (json) {
      ...
      // 根据geoJson画出地图的轮廓, plane-二维世界地图视图平面下画轮廓
    ...
    if (target) {
      switch (currentSetup) {
        ...
        case "towers":
          ...
          if (!storyMode) {
            $("#atlasBox").html(
              "<div class='optionSeparator'>&nbsp;</div><div class='sectionTitle'>Click to view more exports:</div><a target='blank' href='http://atlas.cid.harvard.edu/explore/tree_map/export/" +
                target.iso.toLowerCase() +
                "/all/show/2012/'><img src='images/atlasimages/" +
                co +
                ".png' id='treeMapImage' onError=\"this.onerror=null;this.src='images/noimage.png';\"/></a></div>"
            );
    ...
    var story = [
      {
        ...
        subtitle:
          "This site visualizes the economies of each country as told by the products they export.",
      },
      {
        div: 2,
        setup: "step3",
      ...
      },
      {
        ...
        subtitle:
          "Compare <span style='color:#17becf'>machinery (engines, intergrated circuits, telephones)</span> with <span style='color:#FFC41C'>vegetables (coffee, soya beans, wheat)</span>",
      },
      {
        div: 8,
        setup: "productsphere",
        ...
        subtitle:
          "Some industries have products that have a lot of connections such as <span style='color:#17becf'>machinery</span>, as opposed to <span style='color:#FFC41C'>vegetables</span>.<br/>We call this the product space.",
      },
      {
        div: 9,
        setup: "gridSphere",
        ...
        subtitle:
          "This site allows you to explore the productive similarities of products and countries.",
      },
    ];
    ...
    if (story[step]) {
      ...
      $("#annotation")
        ...
        .fadeOut("fast", function () {
          // story[step - 1]是因为在回调触发时，step已经++1了，为了找回原来的文字内容，需要step-1
          $("#annotation").html(
            "<span class='title'>" +
              story[step - 1]["title"] +
              "</span><br/><div class='subtitle'>" +
              story[step - 1]["subtitle"] +
              "</div>"
          );
